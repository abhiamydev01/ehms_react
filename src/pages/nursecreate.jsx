...
export default function nurseadd() {
    ...
    const handleSubmit = async (e) => {
        ...
        formData.append("code", nursecode);
        formData.append("name", nursename);
        ...
        try {
            const res = await ApiServices.nurseReg(formData, {
                headers: {
                ...
                <form className="space-y-4" onSubmit={handleSubmit}>
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                        <div>
                            <label className="block text-sm font-medium text-gray-600 text-left mb-1">
                                Nurse Code <span className="text-red-500 font-bold">*</span>
                            </label>
                            <input
                                type="text"
                                value={nursecode}
                        ...
                        <div>
                            <label className="block text-sm font-medium text-gray-600 text-left mb-1">
                                Nurse Name <span className="text-red-500 font-bold">*</span>
                            </label>
                            <input
                                type="text"
                                value={nursename}
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-12 gap-4">
                        ...
                        <div className="md:col-span-4">
                            <label className="block text-sm font-medium text-gray-600 text-left mb-1">
                                Experience (Years) <span className="text-red-500 font-bold">*</span>
                            </label>
