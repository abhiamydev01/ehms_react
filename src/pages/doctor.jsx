...
const fetchTransactions = async () => {
  setLoading(true);
  try {
    const res = await ApiService.getAllDoctorList();
  ...
  setLoading(false);
    ...
    const columns = [
        ...
        { name: "Specialist", selector: (row) => row.specialization?.join(", "), sortable: true },
    ...
    return (
        <div className="bg-white rounded-sm border border-gray-200 shadow-xs p-4 overflow-x-auto">
            ...
            <div className="flex justify-between items-center mb-4">
                ...
                <NavLink
                    to={`/${encryptRoute("doctor")}/${encryptRoute("create-doctor")}`}  
